...
* **Modelos 3D de personajes:** *Blocky Characters* por Kenney (Licencia CC0 1.0 Universal - Dominio Público)[cite: 14].
* **Modelos de llave y puerta:** *FREE Doors with Keys: Ready to open* por PolyKebap (Unity Asset Store Standard EULA)[cite: 14].
* Google. (2026). *Gemini* (Versión de agosto de 2026) [Modelo de lenguaje grande]. https://gemini.google.com[cite: 14]
* Unity Technologies. (s.f.). *NavMeshAgent Scripting API*. https://docs.unity3d.com/6000.5/Documentation/ScriptReference/AI.NavMeshAgent.html[cite: 14]
* Unity Technologies. (s.f.). *UI.Button - Unity Scripting API*. https://docs.unity3d.com/es/2017.4/ScriptReference/UI.Button.html[cite: 14]
